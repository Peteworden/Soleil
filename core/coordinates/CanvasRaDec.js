...
export function toAzAlt(canvasRadec, config) {
    if (config.mode == 'AEP') {
...
function toRadec_AEP(canvasRadec, center) {
...
function toAzAlt_View(canvasRadec, center) {
    if (isCenter(canvasRadec)) {
        return center;
    }
...
export function toAzAlt_Live(canvasRadec, orientationData) {

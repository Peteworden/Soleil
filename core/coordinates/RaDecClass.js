"use strict";
// import { CanvasSize, EquatorialCoordinates, LstLat, StarChartConfig, ViewState } from '../../types/index.js';
...
//         return [h, m, s];
//     }
//     angDistanceFrom(coord: RaDec): number {
...
//     }
//     toCartesian(distance: number = 1): Cartesian {
//         const {ra, dec} = this.toRad();
...
//     }
//     precess(precessionAngle?: number, time1?: number | string, time2?: number | string): RaDec {
...
//         const xyz2 = new Cartesian(
//             x*cos - y*COS_EPSL*sin - z*SIN_EPSL*sin,
//             COS_EPSL * (x*sin + cos*(y*COS_EPSL+z*SIN_EPSL)) - SIN_EPSL * (-y*SIN_EPSL+z*COS_EPSL),
//             SIN_EPSL * (x*sin + cos*(y*COS_EPSL+z*SIN_EPSL)) + COS_EPSL * (-y*SIN_EPSL+z*COS_EPSL)
//         );
//         return xyz2.toRaDec();
//         // return this.cartesianToEquatorial(xyz2);
//     }
//     toEcliptic(): {lon: number, lat: number} {
...
//         orientationData?: { alpha: number, beta: number, gamma: number, webkitCompassHeading: number }, force: boolean = false
...
//     }
// }
//# sourceMappingURL=RaDecClass.js.map
import { TLEData, SatellitePosition, SatelliteData } from '../types/index.js';
import { SatelliteCalculator } from '../core/SatelliteCalculator.js';
...
export class SatelliteDataManager {
     ...
     * TLEデータを追加
     */
    addSatellite(tle: TLEData): boolean {
     ...
     * 複数のTLEデータを一括追加
     */
    addSatellites(tles: TLEData[]): number {
        let addedCount = 0;
     ...
     * 全人工衛星の位置を更新
     */
    updateAllPositions(date: Date): void {
     ...
     * 特定の人工衛星の位置を更新
     */
    updateSatellitePosition(key: string, date: Date): boolean {
     ...
     * 全人工衛星の位置を取得
     */
    getAllPositions(): SatellitePosition[] {
     ...
     * TLEデータを文字列から解析
     */
    parseTLEFromString(tleString: string): TLEData | null {
     ...
     * 複数のTLEデータを文字列から解析
     */
    parseMultipleTLEFromString(tleString: string): TLEData[] {
        const tles: TLEData[] = [];
